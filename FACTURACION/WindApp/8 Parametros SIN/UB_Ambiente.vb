...
Public Class UB_Ambinte : Inherits f_base
...
#Region "[metodos]"
    ...
    Private Sub nuevo()
        ...
        Dim objFormModulo As New UI_Ambiente(usuario, clave) With {.MdiParent = MdiParent}
        objFormModulo.Show()
        'Else
    ...
    Private Sub modificar()
        ...
        If lista.Count > 0 Then
            Dim objFormModulo As New UI_Ambiente(usuario, clave, lista, 2) With {.MdiParent = MdiParent}
            objFormModulo.Show()
        Else
    ...
    Private Sub eliminar()
        ...
        lista = getLista()
        If lista.Count > 0 Then
            Dim objFormModulo As New UI_Ambiente(usuario, clave, lista, 3) With {.MdiParent = MdiParent}
            objFormModulo.Show()
        Else
