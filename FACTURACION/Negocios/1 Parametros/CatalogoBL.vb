Imports Entidades
Imports Datos
Public Class CatalogoBL : Inherits Datos.clsCatalogofe
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As Entidades.tb_CatalogoFe)
        Call alta(item)
    End Sub

    Public Sub actualizarBL(ByVal item As Entidades.tb_CatalogoFe)
        Call actualizar(item)
    End Sub

    Public Sub bajaBL(ByVal item As Entidades.tb_CatalogoFe)
        Call baja(item)
    End Sub

    Public Function getCatalogoBL() As DataTable
        Return getCatalogo()
    End Function

    Public Function getCatalogoBL(ByVal item As tb_CatalogoFe) As DataTable
        Return getCatalogo(item)
    End Function

    Public Function getCatalogoGrupoBL(ByVal item As tb_CatalogoFe) As DataTable
        Return getCatalogoGrupo(item)
    End Function

    Public Function getCatalogoBL(ByVal tipo As String, ByVal codError As String) As DataTable
        Return getCatalogo(tipo, codError)
    End Function
