Imports Entidades
Imports Datos
Public Class ModalidadSinBL : Inherits Datos.clsModalidadSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_modalidad)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_modalidad)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_modalidad)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_modalidad) As DataTable
        Return listar(item)
    End Function
