Imports Entidades
Imports Datos
Public Class MetoPagoSinBL : Inherits Datos.clsMetoPagoSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_metoPago)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_metoPago)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_metoPago)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_metoPago) As DataTable
        Return listar(item)
    End Function
