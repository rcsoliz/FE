Imports Entidades
Imports Datos
Public Class MonedaSinBL : Inherits Datos.clsMonedaSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_moneda)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_moneda)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_moneda)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_moneda) As DataTable
        Return listar(item)
    End Function
