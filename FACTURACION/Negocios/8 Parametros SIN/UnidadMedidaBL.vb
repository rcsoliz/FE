Imports Entidades
Public Class UnidadMedidaBL : Inherits Datos.clsUnidMedida
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_unidMedida)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_unidMedida)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_unidMedida)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_unidMedida) As DataTable
        Return listar(item)
    End Function
