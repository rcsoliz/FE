Imports Entidades
Imports Datos
Public Class DocuIdentidadSinBL : Inherits Datos.clsDocuIdentidadSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_docuIdentidad)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_docuIdentidad)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_docuIdentidad)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_docuIdentidad) As DataTable
        Return listar(item)
    End Function
