Imports Entidades
Imports Datos
Public Class DocuSectorSinBL : Inherits Datos.clsDocuSectorSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_docuSector)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_docuSector)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_docuSector)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_docuSector) As DataTable
        Return listar(item)
    End Function
