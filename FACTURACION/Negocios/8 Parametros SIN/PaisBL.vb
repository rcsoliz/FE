Imports Entidades
Imports Datos
Public Class PaisBL : Inherits Datos.clsPaisSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_pais)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_pais)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_pais)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_pais) As DataTable
        Return listar(item)
    End Function
