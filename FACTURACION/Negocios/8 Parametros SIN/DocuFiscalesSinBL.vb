Imports Entidades
Imports Datos
Public Class DocuFiscalesSinBL : Inherits Datos.clsDocuFiscalesSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_docuFiscales)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_docuFiscales)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_docuFiscales)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_docuFiscales) As DataTable
        Return listar(item)
    End Function
