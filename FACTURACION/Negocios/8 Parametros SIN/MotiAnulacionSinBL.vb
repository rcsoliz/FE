Imports Entidades
Imports Datos
Public Class MotiAnulacionSinBL : Inherits Datos.clsMotiAnulacionSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_motiAnulacion)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_motiAnulacion)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_motiAnulacion)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_motiAnulacion) As DataTable
        Return listar(item)
    End Function
