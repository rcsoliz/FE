Imports Entidades
Imports Datos
Public Class MensSoapSinBL : Inherits Datos.clsMensSoapSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_mensSoap)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_mensSoap)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_mensSoap)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_mensSoap) As DataTable
        Return listar(item)
    End Function
