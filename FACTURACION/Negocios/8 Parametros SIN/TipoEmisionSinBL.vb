Imports Entidades
Imports Datos
Public Class TipoEmisionSinBL : Inherits Datos.clsTipoEmisionSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_tipoemision)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_tipoemision)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_tipoemision)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_tipoemision) As DataTable
        Return listar(item)
    End Function
