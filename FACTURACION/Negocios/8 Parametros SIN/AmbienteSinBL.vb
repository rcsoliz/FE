Imports Entidades
Imports Datos
Public Class AmbienteSinBL : Inherits Datos.clsAmbienteSin
...
#Region "[metodos]"
    ...
    Public Sub altaBL(ByVal item As tb_ambiente)
        Call alta(item)
    End Sub

    Public Sub bajaBL(ByVal item As tb_ambiente)
        Call baja(item)
    End Sub

    Public Sub modificarBL(ByVal item As tb_ambiente)
        Call modificar(item)
    End Sub

    Public Function listarBL(ByVal item As tb_ambiente) As DataTable
        Return listar(item)
    End Function
